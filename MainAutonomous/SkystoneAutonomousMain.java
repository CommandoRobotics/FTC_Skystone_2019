...
// @Autonomous(name="Red Autonomous Main")
...
//       //forward
//       chassis.driveStraightPID(14, 0.5f);

//       //right strafe
//       chassis.driveStrafePID(-62, 0.5f);
...
//         chassis.driveStraightPID(10, .4f);

//         //Wait a bit to make sure we get the skystone
//         double startTime = System.nanoTime();
//         while ((System.nanoTime() - startTime) < 1500) {
//           chassis.stopMotors();
//         }
...
//       chassis.driveStrafePID(distanceTraveled, 0.5f);

//       if (!error) {
//         //strafe right to platform
//         chassis.driveStrafePID(62, .5f);
